...
if (WebUI.verifyElementVisible(findTestObject('Page_OrangeHRM/div_Invalid credentials'), FailureHandling.OPTIONAL)) {
	println "INVALID CREDENTIALS!"
} else {
	WebUI.verifyElementVisible(findTestObject('Page_OrangeHRM/img_Upgrade_oxd-userdropdown-img'))
}
